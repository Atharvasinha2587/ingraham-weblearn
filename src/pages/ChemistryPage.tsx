...
import { ArrowLeft, Atom, FlaskConical } from "lucide-react";
...
const experiments = [
  ...
  { icon: FlaskConical, title: "Chemistry Lab", desc: "Mix chemicals in virtual glassware. Observe density, color changes, and liquid levels.", route: "/simulation/chemistry-lab" },
];
    ...
    <div className="min-h-screen bg-gradient-to-br from-background to-secondary/30 px-6 py-12">
      <div className="mx-auto max-w-4xl">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          <p className="mb-2 text-xs font-semibold uppercase tracking-widest text-[hsl(160,60%,42%)]">02 — Chemistry</p>
        ...
        <div className="grid gap-5 sm:grid-cols-2">
          {experiments.map((exp, i) => (
            <motion.div
              ...
              className="glass-panel group cursor-pointer p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-[hsl(160,60%,42%)]/10"
            >
              <exp.icon className="mb-3 h-6 w-6 text-[hsl(160,60%,42%)]" />
